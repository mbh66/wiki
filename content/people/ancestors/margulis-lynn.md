...
For the [[frameworks/three-futures|Transcendence]] trajectory and the [[frameworks/emancipation-architecture|Emancipation Architecture]], endosymbiosis is the biological precedent for the specific move human civilization is now required to make: formerly competing entities structurally incorporated into new wholes that can navigate conditions no single partner could handle alone.
...
- [Margulis — PDF](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2FMichaelHaupt%2F4ODX-BYChy.pdf?alt=media&token=1762b024-d97f-4ffd-9f7a-98923e547475)

## External links

- [Wikipedia](https://en.wikipedia.org/wiki/Lynn_Margulis)
- [*Symbiotic Planet* on Amazon](https://www.amazon.com/dp/0465072720/)
- [Lynn Margulis and the endosymbiont hypothesis: 50 years later (NCBI)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5426843/)
- [ISEPP lecture](https://www.isepp.org/Pages/San%20Jose%2004-05/MargulisSaganSJ.html)
