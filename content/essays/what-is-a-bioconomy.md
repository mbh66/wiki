...
The BioConomy is that architecture. It nests three scales: [[biohub|BioHub]] (the coordination body), BioRegion (the geography), BioConomy (the emergent economy). The stack is called the [[biostack|BioStack]]. Coordination at each level supports the next.
