...
source_documents:
  ...
  - BioRegion_Establishment_Template.md
  - BioConomy_Value_Proposition_Template.md
  - Bankable_Service_Alignment_Template_v0_1.md
...
The [[frameworks/time-framework|TIME Diagnostic]] runs alongside the BioHub Identity Template. Its output feeds Prompts 2 and 3 of the Identity Template and can be attached to subsequent templates through the Field and Lineage Positioning document.
...
If you are new to the [[bioconomy|BioConomy]] framework, read [[essays/what-is-a-biohub|What Is a BioHub]] and [[essays/how-to-engage-your-bioregion|How to Engage Your Bioregion]] first. The templates presuppose the framework.
