...
aliases: ["cosmo-local", "cosmo-localism", "design global manufacture local"]
tags: ["concept", "bioconomy", "core-framework", "production"]
created: 2026-09-01
updated: 2026-08-25
source_project: "BioConomy"
source_documents: ["CosmoLocal_Production_Notion_Export"]
...
For a [[biohub|BioHub]], the two layers are concrete. The global-facing layer is the educational material on this site, the published research, the open-source methodology, the BioHub Diagnostic, the [[concepts/water-retention-landscapes|Water Retention Landscape]] protocols, the [[concepts/commitment-pooling|commitment pooling]] documentation, and the governance templates. This material is available to any bioregion engaging with the same coordination questions. It is the knowledge commons.
