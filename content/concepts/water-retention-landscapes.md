...
aliases: ["water retention landscape", "WRL", "catchment restoration"]
tags: ["concept", "bioconomy", "ecological-science", "water", "restoration"]
created: 2026-09-01
updated: 2026-08-25
source_project: "BioConomy"
source_documents: ["Water_Retention_Landscapes_Notion_Export"]
...
A bioregion that can demonstrate (through gauged flow measurement, soil moisture monitoring, and satellite verification) that its coordinated restoration activity produces measurable increases in water yield holds a product. That product can be tendered into instruments like the Cape Water [[performance-based-bond|Performance-Based Bond]], contracted through water funds, or priced against the avoided cost of built infrastructure (desalination, inter-basin transfer, dam expansion). See [[concepts/commitment-pooling|Commitment Pooling]] and [[concepts/bioregional-economics|Bioregional Economics]] for the financing architecture.
...
- [[strategic-water-source-area-swsa|Strategic Water Source Area (glossary)]]

## Sources

- Kravčík, M. et al. (2007). *[[sources/kravcik-water-recovery|Water for the Recovery of the Climate]]*
- Jehne, W. *[[sources/jehne-regenerate-earth|Regenerate Earth]]*
- Yeomans, P.A. (1954). *[[sources/yeomans-water-for-every-farm|Water for Every Farm]]*
- Holzer, S. (2011). *[[sources/holzer-permaculture|Sepp Holzer's Permaculture]]*
- Andrews, P. (2006). *[[sources/andrews-back-from-the-brink|Back from the Brink]]*
- Liu, J. D. (2012). *[[sources/liu-green-gold|Green Gold]]* (documentary)
- [[sources/van-wyk-1987|Van Wyk, D.B. (1987). "Some effects of afforestation on streamflow in the Western Cape Province"]]
- [[sources/lemaitre-2019|Le Maitre, D.C. et al. (2019). "Impacts of invasive Australian acacias on the fynbos biome"]]
- [[sources/mills-cowling-2013|Mills, A.J., Cowling, R.M. et al. (2013). "Restoring the fauna and flora of transformed renosterveld"]]
- [[sources/morris-2014-bioprecipitation|Morris, C.E. et al. (2014). "Bioprecipitation: a feedback cycle"]]
