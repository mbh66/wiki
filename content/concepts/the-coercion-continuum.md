...
aliases: ["coercion continuum", "twelve thousand year continuum"]
tags: ["concept", "emancipation-architecture", "monetary-design"]
created: 2026-08-25
updated: 2026-08-25
source_project: "BioConomy"
source_documents: ["EA Patron Project Criteria.md"]
epistemic_status: "working-hypothesis"
---

[[glossary/coercion-continuum|The Coercion Continuum]] is the [[frameworks/emancipation-architecture|Emancipation Architecture's]] structural reading of the past twelve thousand years of monetary design as a single continuous lineage, each iteration of which has served extraction and social stratification. The EA's six structural inversions are the specific reversals of that lineage its monetary architecture proposes.
...
**Ecological backing.** Money is backed by the health of the substrate it serves: soil carbon, water [[glossary/retention-economics|retention]], biodiversity, and the coordination capacity of the [[glossary/bioregion|bioregion]]. Backing serves substrate rather than extracting from it.
...
**[[glossary/regenerative|Regenerative]] Participation Income.** A monetary primitive (RPI) provides an income floor earned through verified regenerative activities: ecological restoration, community coordination, caregiving, cultural transmission. Access to money is decoupled from participation in a labor market.
...
The alternative substrate the EA proposes is called the [[frameworks/emancipation-architecture|Emancipation Architecture]] because its design goal is the release of coordination capacity that the Coercion Continuum has systematically suppressed. The word "emancipation" is not decorative. It names the specific structural change: from a monetary substrate that constrains coordination forms to one that enables them.
